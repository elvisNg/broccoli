...
import (
	...
	conf "github.com/elvisNg/broccoli/config"
	broccolictx "github.com/elvisNg/broccoli/context"
	"github.com/elvisNg/broccoli/errors"
	lock "github.com/elvisNg/broccoli/lock/redis"
...
func (session *DBSession) DoTransactWithLock(ctx context.Context, key string, txFunc func(*DBSession) error) (err error) {
	...
	rdc, err := broccolictx.ExtractRedis(ctx)
	if err != nil {
		logger.Error(err)
		return
	}
